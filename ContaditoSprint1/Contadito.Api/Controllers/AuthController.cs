...
namespace Contadito.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        /// <summary>
        /// Registra un nuevo tenant con su usuario propietario.
        /// </summary>
        ...
        public async Task<ActionResult<AuthResponse>> RegisterTenant([FromBody] RegisterTenantRequest req)
        {
            ...
            var user = new User
            {
                TenantId = tenant.Id,        // tenant.Id es BIGINT → mapeado como long
                Name = req.OwnerName,
        ...
        public async Task<ActionResult<AuthResponse>> Login([FromBody] LoginRequest req)
        {
            var user = await _db.Users
                .FirstOrDefaultAsync(u => u.Email == req.Email && u.DeletedAt == null);
        ...
        private string GenerateToken(User user)
        {
            var claims = new List<Claim>
            {
                ...
                new Claim("tenant_id", user.TenantId.ToString()), // TenantId convertido explícitamente a string
